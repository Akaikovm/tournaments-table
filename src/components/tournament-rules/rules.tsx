  ...
  return (
    <div className="p-6 pt-4 pb-4 mb-12 relative">
      ...
      <ul className="list-disc list-inside pl-3">
        ...
        <li>
          <span className="relative right-2">
            Si el torneo no incluye CPU, cualquier nivel de dificultad puede ser
            usado en el juego (caso de que sea videojuego)
          </span>
        </li>
        <li>
          <span className="relative right-2">
        ...
        <li>
          <span className="relative right-2">
            ...
            alguno de los otros 2 no quiera participar en dicho torneo bien sea
            porque no le gusta el juego o porque no tiene tiempo para
            participar.
          </span>
        </li>
        <li>
          <span className="relative right-2">
            Todo torneo suspendido por X razon dara como campeon y subcampeon a
            los 2 primeros lugares del torneo hasta el momento de la
            cancelacion.
          </span>
        </li>
        <li>
          <span className="relative right-2">
            Para empezar algun torneo en estado de ebriedad los 4 participantes
            principales deben estar ebrios
          </span>
        </li>
        <li>
          <span className="relative right-2">
            Para que un torneo de algun juego de nintendo que involucre a mario
            bros sea valido los jugadores principales deben dar validez previo
            torneo.
          </span>
        </li>
        <li>
        ...
        <li>
          <span className="relative right-2">
            Si por alguna razon, el torneo comienza y alguno de los jugadores no
            tiene el mismo nivel de dificultad y/o modo de juego y llega a
